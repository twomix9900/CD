...
@Component({
  selector: 'app-random-race',
  templateUrl: './random-race.component.html',
  styleUrls: ['./random-race.component.scss']
})
export class RandomRaceComponent implements OnInit {
  _user: Object;
  _userId: String;
  _userGroups: any [];
  ...
  setRandomCourse() {
    const randInt = this.getRandomInt(0, this._platformCourses.length - 1);
    this._randomCourse = this._platformCourses[randInt];
    this._selectedCourse = this._randomCourse;
    this.setCourse();
  }
