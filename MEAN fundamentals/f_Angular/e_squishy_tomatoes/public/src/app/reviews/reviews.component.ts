...
export class ReviewsComponent implements OnInit {
  ...
  deleteReview(reviewid: string) {
    console.log(this._movieId, reviewid)
    let reviewObs = this._httpService.deleteReview(this._movieId, reviewid);
    reviewObs.subscribe((data) => {
      console.log("Review deleted from DB", data);
      this.getMovie();
    });
  }
